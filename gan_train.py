...
parser.add_argument('--g_activation', type=int, default=19, help='Final activation function for generator')
parser.add_argument('--g_funit', type=int, default=19, help='Filter unit size for generator')
parser.add_argument('--d_activation', type=int, default=19, help='Final activation function for discriminator')
parser.add_argument('--d_funit', type=int, default=19, help='Filter unit size for discriminator')
