...
parser.add_argument('--g_activation', type=int, default='PReLU', help='Final activation function for generator')
parser.add_argument('--g_funit', type=int, default=32, help='Filter unit size for generator')
parser.add_argument('--d_activation', type=int, default='PReLU', help='Final activation function for discriminator')
