...
# Params
parser = argparse.ArgumentParser(description='PyTorch RedCNN')
parser.add_argument('--model', default='RedCNN', type=str, help='choose a type of model')
...
class RedCNN(nn.Module):
    def __init__(self, out_channels=96, depth=17, n_channels=64, image_channels=3, use_bnorm=True, kernel_size=3):
