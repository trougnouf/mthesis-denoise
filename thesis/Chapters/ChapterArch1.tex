...
HulDisc is a matching discriminator network which follows the same structure as the aforementioned HulNet but end in the middle with a single probabilistic feature. % mention that we'll talk about the GAN?
