...
The networks' training performance is shown on figures \ref{cgan-comp} and \ref{cgan-complonger}. The baseline is a single generative U-Net network, and we also trained a single Hulb128Net network. The Hulb128Net network appears to perform better than
