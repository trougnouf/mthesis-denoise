...
While it may seem counter-intuitive to train the discriminator with mini-batches of only one label at a time, this phenomenon may be explained with the use of Batch Normalization which keeps running statistics on the given batch and may performs better given low-variance input data. \cite{gantechniques}\cite{bn}
  \item \ac{cGAN}
