...
\begingroup
    ...
    \chapter*{Acronyms}
    \begin{acronym}[UMLX]
    	\acro{NIND}{Natural Image Noise Dataset \cite{nind-ntire}\cite{nind-wc}}
    	...
    	\acro{DND}{Darmstadt Noise Dataset \cite{darmstadt}}
    	...
    	\acro{SID}{See-in-the-Dark \cite{learningtoseeinthedark}}
    	\acro{SSIM}{Structural Similarity \cite{ssim}}
    	\acro{WGAN}{Wasserstein GAN \cite{wgan}}
